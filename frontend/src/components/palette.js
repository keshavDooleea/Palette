...
export default class Palette extends Component {
  ...
  openHamburger() {
    const hamburgers = document.querySelectorAll(".palette_hamburger span");

    hamburgers.forEach(span => {
      span.style.backgroundColor = "#f4f3ef";
    });
    document.querySelector(".palette_mobile_nav").style.display = "flex";
    document.querySelector(".palette_mobile_nav").classList.remove("nav_slide_in");
    document.querySelector(".palette_mobile_nav").classList.add("nav_slide_out");
  ...
  closeHamburger() {
    ...
    if (this.state.isMobileNavLoaded) {
      ...
      document.querySelector(".palette_mobile_nav").classList.remove("nav_slide_out");
      document.querySelector(".palette_mobile_nav").classList.add("nav_slide_in");
    }
  }
  ...
  render() {
    return (
      <div className="palette">
        ...
        <div className="palette_mobile_nav">
          <ul>
            <li>
              <NavLink
                to={"/palette"}
        ...
        <nav className="palette_nav">
          ...
          <div className="palette_hamburger"
